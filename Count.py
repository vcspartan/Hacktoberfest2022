# Python3 code to count the number of possible triangles using brute force approach Function to count all possible triangles with arr[] elements
...
# I learnt this code from one of the friends
